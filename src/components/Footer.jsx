          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-primary-600/20 to-purple-600/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 -inset-2"></div>
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-56 px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl shadow-xl text-xs text-gray-300 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 pointer-events-none z-20">
                  <p className="font-semibold text-white mb-1">Get in touch</p>
                  <p>support@jobportal.com</p>
                  <p>+1 (555) 123-4567</p>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 -mt-1 w-2 h-2 bg-gray-800 border-b border-r border-gray-700 rotate-45"></div>
                </div>
              </Link>
            </div>
